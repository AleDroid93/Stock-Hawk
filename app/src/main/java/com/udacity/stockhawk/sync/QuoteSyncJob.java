    ...
    static void getQuotes(final Context context) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                BigDecimal quotePercChange = quote.getChangeInPercent();
                float price;
                float change;
                float percentChange;
                Timber.d("richiesta avvenuta");
                ...
                if(stock != null && quotePrice != null && quoteChange!= null && quotePercChange!= null) {
                    ...
                    change = quoteChange.floatValue();
                    percentChange = quotePercChange.floatValue();
                    ...
                    Timber.d("HISTORY: length  "+history.size()+"\n"+ historyBuilder.toString());
                    quoteCVs.add(quoteCV);
                    Timber.d("STOCK ELEMENTS: "+ quoteCV.size());
                }else{
                    Timber.d("EHILA");
